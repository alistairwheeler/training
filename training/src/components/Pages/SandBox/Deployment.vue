<template>
  <div class="wrapper">
    <div class="sandbox-redirect">
      ...
      <h4 class="end-text">Voilà, c'est tout ! Si vous êtes arrivés jusqu'ici, allez vérifier vos mails, vous devriez avoir une bonne surprise. A tout de suite sur Simplicité !</h4>
    </div>
  </div>
</template>
